...
if(exist('scriptTrackGeneralPars','var'))
    gapCloseParam.timeWindow = scriptTrackGeneralPars.gapClosingTimeWindow;    
    gapCloseParam.mergeSplit = scriptTrackGeneralPars.gapClosingMergeSplit;    
else
